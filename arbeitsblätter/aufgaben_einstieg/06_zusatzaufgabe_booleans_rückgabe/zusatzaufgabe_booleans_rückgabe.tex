...
def paperwork_helper(n: int, m: int) -> bool:
	return n > 0 and m > 0
...
\huge{\hinweis{Nutze in den folgenden Aufgaben kein \mintinline{python}{if}/\mintinline{python}{else}-Statement!}}

 \normalsize

\vskip 30 pt
\begin{aufgabe} \noindent 
Schreibe eine Funktion \mintinline{python}{hoop_count_helper}, die Integer übergeben bekommt und ein Boolean zurückgibt.
Die Funktion gibt zurück, ob diese Zahl größer oder gleich groß wie $10$ ist.
\begin{pyconsole}
hoop_count_helper(9)
hoop_count_helper(10)
hoop_count_helper(11)
\end{pyconsole}
\end{aufgabe}

\begin{aufgabe} \noindent 
Schreibe eine Funktion \mintinline{python}{paperwork_helper}, die zwei Integer übergeben bekommt und  ein Boolean zurückgibt.
Die Funktion gibt zurück, ob beide Zahlen größer als $0$ sind.
\begin{pyconsole}

paperwork_helper(1, 0)
paperwork_helper(-1, 10)
paperwork_helper(2, 3)
\end{pyconsole}

\end{aufgabe}

\begin{aufgabe} \noindent 
Schreibe eine Funktion \mintinline{python}{player_1_wins}, die zwei Strings übergeben bekommt. Dabei handelt es sich um die Entscheidungen von zwei Spielern bei dem Spiel Schere-Stein-Papier.
Die Funktion gibt zurück, ob der erste Spieler gewonnen hat.
\begin{pyconsole}

player_1_wins("rock", "paper")
player_1_wins("rock", "scissors")
player_1_wins("rock", "rock")
player_1_wins("paper", "paper")
player_1_wins("paper", "scissors")
player_1_wins("paper", "rock")
player_1_wins("scissors", "paper")
player_1_wins("scissors", "scissors")
player_1_wins("scissors", "rock")
\end{pyconsole}
